...
public class MainActivity extends AppCompatActivity {
    ...
    public void rotate(View view) {
        ...
        Random rand = new Random(); // 룰렛이 언제 멈출지는 랜덤으로 설정 랜덤 객체 생성
        int degree_rand = rand.nextInt(360); // 360 중 랜덤을 선택
        endDegree = startDegree + degree_rand + 360 * 6 ;  //6회전 하고 멈춤
    ...
    public void animationTest(View view) {  // 애니메이션 모션
        ...
        objectRotate.setInterpolator(new AccelerateDecelerateInterpolator());
         //objectRotate.setInterpolator(new LinearInterpolator());
        ...
        ObjectAnimator objectY = ObjectAnimator.ofFloat(iVStar, "translationY", 0f, 2000f, 0); //별을 선택하면 돌아감
